...
type MatrixData struct {
	...
	Matrix        []float64              `protobuf:"fixed64,1,rep,packed,name=matrix,proto3" json:"matrix,omitempty"`                   // Flattened matrix A
	Vector        []float64              `protobuf:"fixed64,2,rep,packed,name=vector,proto3" json:"vector,omitempty"`                   // Vector b
	MatrixRows    int32                  `protobuf:"varint,3,opt,name=matrix_rows,json=matrixRows,proto3" json:"matrix_rows,omitempty"` // Number of rows in matrix A
	MatrixCols    int32                  `protobuf:"varint,4,opt,name=matrix_cols,json=matrixCols,proto3" json:"matrix_cols,omitempty"` // Number of columns in matrix A
	TargetIdx     int32                  `protobuf:"varint,5,opt,name=target_idx,json=targetIdx,proto3" json:"target_idx,omitempty"`    // Index of target edge in the matrix
...
func (x *MatrixData) String() string {
...
func (x *MatrixData) GetVector() []float64 {
	if x != nil {
		return x.Vector
	}
	return nil
...
func (x *MatrixData) GetMatrixRows() int32 {
	if x != nil {
		return x.MatrixRows
	}
	return 0
...
func (x *MatrixData) GetMatrixCols() int32 {
	if x != nil {
		return x.MatrixCols
	}
	return 0
...
func (x *MatrixData) GetTargetIdx() int32 {
	if x != nil {
		return x.TargetIdx
	}
	return 0
...
type SolutionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Solution      []float64              `protobuf:"fixed64,1,rep,packed,name=solution,proto3" json:"solution,omitempty"` // Solution vector x
	Success       bool                   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"`           // Whether the solution was found successfully
...
func (x *SolutionResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_proto_networkanalyser_networkanalyser_proto_rawDesc = []byte{
	...
	,
	...
	0x20, 0x03, 0x28, 0x01, 0x52, 0x08, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18,
	...
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x62,
	0x0a, 0x0f, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x7a, 0x65,
	0x72, 0x12, 0x4f, 0x0a, 0x0b, 0x53, 0x6f, 0x6c, 0x76, 0x65, 0x4d, 0x61, 0x74, 0x72, 0x69, 0x78,
	0x12, 0x1b, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73,
	0x69, 0x73, 0x2e, 0x4d, 0x61, 0x74, 0x72, 0x69, 0x78, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x21, 0x2e,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x2e,
	...
	0x65, 0x72, 0x66, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x3b, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
